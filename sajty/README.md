...
| Сайт | Форма, которая открывается |
|---|---|
| crossair-compressor.ru | своя, 173/5pc41r «Запросить коммерческое предложение» |
| enger-air.ru | своя, 160/lzzwog «Запросить коммерческое предложение» |
| остальные десять | 7/40ef1t «Запросить коммерческое предложение» |

Надпись на кнопке везде «Получить КП».

Своей формы «Запросить КП» в Битрикс24 нет у berg, ekomak, fini и ironmac -
им поставлена та же форма 7/40ef1t, что у abac, ac, dali, kraftmann, remeza и
zif. Портал Битрикс24 у всех сайтов общий, заявки различаются по адресу
страницы, который он записывает сам. Появится отдельная форма под сайт -
поменять id в одной строке реестра `verstka.py`.
