...
for o in stroki:
    ...
    if vid_n and vid_f and nasha:
        prichina = 'видно на странице: фамилия, номер и наша машина в видимом тексте'
        ...
        ne_prov.append((o, 'человек и номер верны, но машина на странице ЧУЖАЯ '
                           '(нашей машины в тексте нет)'))
        sch['человек верен, машина на странице чужая'] += 1
    else:
        if raz_n and raz_f:
