...
NE_NASHA = [
    ...
    ('садовый инструмент, не машина',
     re.compile(r'бензинов\w+\s+воздуходувк|ранцев|садов\w+\s+воздуходувк|воздуходувк\w*[-\s]пылесос|'
                r'воздуходувк\w+\s+для\s+уборки|уборки\s+территории|аккумуляторн\w+\s+воздуходувк', re.I)),
    # Вихревая (она же с боковым каналом) — принцип не центробежный, мощности другие.
    ('вихревая воздуходувка, принцип не центробежный',
     re.compile(r'вихрев\w+\s+воздуходувк|вихрев\w+\s+нагнетател', re.I)),
