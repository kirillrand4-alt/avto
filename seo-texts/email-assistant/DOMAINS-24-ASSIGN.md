...
> ⛔ **ХОЛД: прогрев/отправку НЕ запускать** до отдельной команды владельца (письма ещё
> не откалиброваны). Настройку доменов/DNS/ящиков/`sender.yaml` делать можно — боевой
> прогрев и реальные отправки НЕТ.
