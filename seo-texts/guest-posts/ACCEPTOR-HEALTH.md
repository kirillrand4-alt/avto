...
> **ЗАКРЫТО 20.08 владельцем.** Проверка URL в Search Console: страница
> `/catalog/vozdushnye-kompressory/promyshlennye/` — «URL есть в индексе Google»,
> «Эта страница проиндексирована», обнаружено 20 элементов товаров с микроразметкой
> и строки навигации без ошибок. То же по второй странице. **Googlebot получает
> настоящую страницу, а не заглушку.** Мой 403 — это WAF против датацентровых IP;
> робота Google сайт пропускает по обратному DNS, как и положено.
> Целевые страницы не меняем. Вопрос про карту сайта тоже снимается: страницы
> индексируются и без неё, внутренних ссылок Google хватает.
