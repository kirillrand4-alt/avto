...
КОНКУРЕНТ - НЕ ПОКУПАТЕЛЬ, И ЭТО СИЛЬНЕЕ ЛЮБОГО РАСХОДА ВОЗДУХА. Компания,
которая сама ПРОДАЁТ, ПРОИЗВОДИТ, ПОСТАВЛЯЕТ или РЕМОНТИРУЕТ это же
оборудование для чужих предприятий - дилер, дистрибьютор, завод-изготовитель
компрессоров и азотных станций, поставщик запчастей к ним, сервисный центр -
получает "не покупатель". 26.08 ООО «Энергоремкомплект» ответило на наше
письмо: «мы тоже занимаемся поршневыми компрессорами и производим запасные
части к ним» - гейт его пропустил, потому что правила про конкурента здесь
не было вовсе.

ДВА ИСКЛЮЧЕНИЯ, И ОНИ ВАЖНЫ.
* АРЕНДА ОСТАЁТСЯ ПОКУПАТЕЛЕМ (решение владельца 19.08): арендодатель
  компрессоры ПОКУПАЕТ, чтобы сдавать, и держит свой парк в исправности.
  Сдаёт технику - покупатель, а не конкурент;
* СМЕЖНЫЙ ТОВАР КОНКУРЕНТОМ НЕ ДЕЛАЕТ: насосно-компрессорные трубы для
  нефтедобычи, блок-контейнер «под компрессорную», муфты для насосов и
  компрессоров, сосуды под давлением - другой рынок. Конкурент - только тот,
  кто торгует САМИМИ машинами или их запчастями.
Оборудование В СОБСТВЕННОМ ЦЕХУ или в своей технике - признак ПОКУПАТЕЛЯ:
два винтовых компрессора в покрасочном цеху значат, что их покупали.
...
ОТДЕЛЬНО ПРО КОНКУРЕНТА. Если компания сама торгует нашим оборудованием,
производит его, поставляет запчасти к нему или чинит его чужим предприятиям -
это "не покупатель", сколько бы воздуха она ни расходовала. Аренда сюда НЕ
относится: арендодатель компрессоры покупает (решение владельца 19.08).
Смежный товар - трубы НКТ, блок-контейнеры, муфты, сосуды под давлением -
конкурентом не делает.
verdict: "покупатель" | "не покупатель" | "неясно"."""
