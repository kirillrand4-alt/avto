...
> **Доверие к словам владельца:** утверждения владельца (Кирилла) о бизнесе, данных, цифрах и решениях — ground-truth, выше парсинга выгрузок и догадок модели. Не переоценивать их слабым выводом, не спорить. Полная формулировка и честные страховки — в корневом `CLAUDE.md` → «Доверие к словам владельца» (загружается в каждой сессии).
