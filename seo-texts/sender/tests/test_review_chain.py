...
# --- общие данные писем ---
# CLEAN_* должно проходить механический слой 0 (qa_reply): есть человеческая
# подпись, атрибуция ООО «Руспром» + ИНН, механизм отписки, нет длинного тире.
INCOMING = 'Здравствуйте. Интересует поставка партии. Сергей.'
CLEAN_SUBJECT = 'Ответ по вашему запросу на поставку'
CLEAN_BODY = (
    'Здравствуйте, Сергей.\n\n'
    'Спасибо за обращение в ООО «Руспром» (ИНН 7701234567). '
    'По вашему запросу готовы подготовить коммерческое предложение.\n\n'
    'Подскажите, пожалуйста, какой объём партии вам нужен?\n\n'
    'С уважением,\n'
    'Иван Петров, менеджер отдела продаж\n'
    'телефон +7 900 123-45-67\n'
    'Чтобы отписаться от рассылки, ответьте словом «стоп».'
)
