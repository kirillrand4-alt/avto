...
export const SCREENS: ScreenDef[] = [
  ...
  // Ручная загрузка партии рядом с базой получателей: владелец грузит
  // сам, не дожидаясь серверных скриптов (11.08).
  { n: 16.1 as unknown as number, title: "Загрузить базу", path: "/import", roles: ["owner"], live: true, group: "Инфраструктура" },
