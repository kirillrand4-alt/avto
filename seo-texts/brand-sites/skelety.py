...
NESUSHCHIE = {
 'kompressornaya-stanciya': {
   'станция против отдельного компрессора': r'станц\w* (и|или|против|вместо)|отдельн\w* компрессор|целиком|комплект',
 ...
 'azotnaya-stanciya-modulnaya': {
   'удушье в замкнутом объёме': r'удуш|вытесн|датчик кислород|замкнут|аварийн\w* вентиляц',
