...
def прогон(skolko=1000, potokov=8):
    ...
    # минутами. Цикл паспортов держит свою транзакцию, пока ждёт сеть, и двое
    # упирались друг в друга насмерть. Коммит после каждой компании (ниже)
    # сокращает удержание до доли секунды на строку.
