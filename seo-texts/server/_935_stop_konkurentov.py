...
ИННЫ = {'7450061013': 'ЧЗМЭК: МКС, генераторы азота',
        ...
        # спорные — решение владельца 17.08 «двое спорных в стоп»
        '7438011866': 'Техгаз: продажа техгазов, соперник генераторов азота',
        '4802013996': 'Челси Вэлдинг Рус: блочно-модульные станции по ТЗ'}
