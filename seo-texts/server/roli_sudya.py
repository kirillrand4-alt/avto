...
- ИМЕННОЙ ящик (в адресе фамилия человека) с названной должностью СОХРАНЯЕТ эту
  должность, даже если рядом перечислены другие люди. «Заместитель директора –
  руководитель проекта» это «директор», а не «общий»;
- «общий» ставится ОБЩЕМУ ящику (info@, office@, mail@, zakaz@), и особенно
  когда один такой адрес указан сразу у нескольких должностей — тогда угадывать
  ближайшую нельзя;
