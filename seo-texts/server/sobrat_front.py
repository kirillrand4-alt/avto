...
def main():
    ...
    # «передан в Bitrix» -> «отдали в Bitrix»: ярлык переименован 20.08 по
    # словам владельца («статус отдали в битрикс»), опору двигаем следом,
    # иначе каждая сборка кричит «потеряно» на собственное переименование.
    ОПОРЫ = ('Лента лидов', 'Подтвердить отправку', 'Мои лиды',
             'квалифицирован', 'отдали в Bitrix', 'Открыл')
    свежий = ''
