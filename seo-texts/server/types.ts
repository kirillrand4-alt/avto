...
export interface Lead {
  ...
  /** Копии письма, поставленные по автоответу на другой адрес. Статус живой:
   *  pending|edited|approved|sent|skipped|stoplist (владелец 20.08 — «не
   *  понятно, на копию письма мы написали такое же письмо или нет»). */
  kopiya?: Array<{ email: string; status: string; ts: string | null;
                   chelovecheski?: string }> | null;
}
