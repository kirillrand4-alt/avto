...
_VK_PHRASES = [
    'новый завод', 'строительство завода', 'запуск завода', 'реконструкция завода', 'модернизация завода',
    'новый цех', 'запуск производства', 'новое производство', 'модернизация производства',
    'расширение производства', 'производственный комплекс', 'ввод в эксплуатацию', 'запустили линию',
    'новая производственная линия', 'инвестпроект', 'индустриальный парк', 'резидент ОЭЗ', 'займ ФРП',
    'импортозамещение', 'закупили оборудование',
]
