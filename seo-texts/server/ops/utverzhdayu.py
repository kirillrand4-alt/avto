...
Читаем docx и rtf (это zip и размеченный текст, сторонних библиотек не нужно),
PDF пропускаем честно — разбирать его нечем. Приоритет файлов: техническое
задание и документация о закупке, извещение последним.
