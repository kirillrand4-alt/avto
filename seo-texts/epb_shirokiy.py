...
# Рабочий каталог задаётся ЯВНО. Прогон уже падал оттого, что `cd` в составной команде не
# доехал и скрипт искал список ИНН в каталоге репозитория: путь к данным нельзя оставлять
# на волю того, откуда тебя запустили.
