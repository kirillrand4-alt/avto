...
Судит модель из MODEL_RAZBOR (умолчание gemini-3.6-flash: deepseek-v4-pro шлюз убрал 03.08). Один вопрос на строку,
...
# Модель берётся из окружения, а умолчание — ЖИВОЕ. Предупреждение 2-й сессии 03.08:
# мёртвая модель в умолчании опаснее её отсутствия — прогон возвращает «ничего не
# нашлось» вместо ошибки, и это неотличимо от честного нуля.
MODEL = os.environ.get('MODEL_RAZBOR', 'gemini-3.6-flash')
