...
BAZA = r'C:\sender'
OUT = os.path.join(BAZA, 'park_gpb_tekst.jsonl')
UA = ('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 '
      '(KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36')
NOMERA = ['ГП415801', 'ГП339353']
PARAMY = ['search']
        ...
        for nom in NOMERA[:2]:
            for par in PARAMY:
                ...
                try:
                    ...
                    # ГЛАВНОЕ: что стоит ВОКРУГ номера — карточка нашего лота или что-то иное
                    i = t.find(nom)
                    r['vokrug_nomera'] = t[max(0, i - 400):i + 700] if i >= 0 else ''
                    r['tekst_nachalo'] = t[:900]
