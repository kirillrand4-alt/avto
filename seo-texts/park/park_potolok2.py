...
BAZA = r'C:\sender'
OUT = os.path.join(BAZA, 'park_potolok2.jsonl')
UA = ('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 '
      '(KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36')
ZAPROSY = ['винтовой компрессор', 'поршневой компрессор', 'центробежный компрессор',
           'компрессорная установка', 'компрессор', 'воздуходувка', 'турбокомпрессор',
           'нагнетатель', 'осушитель сжатого воздуха', 'генератор азота',
           'генератор кислорода', 'кислородная станция', 'компрессорное оборудование']
def _hrom():
    ...
    with sync_playwright() as p:
        ...
        for q in ZAPROSY:
            ...
            try:
                ...
                i = t.find('запис')
                r['vokrug'] = t[max(0, i - 180):i + 60] if i >= 0 else t[:220]
