...
PERED_ADRESOM = re.compile(r'([^|]{6,200}?)\s*Местонахождение', re.S)
MUSOR_V_IMENI = re.compile(r'^(?:44-ФЗ|223-ФЗ|Иное|Заблокирована|Подписаться[^|]*|\s|,)+')
